...
class Schwierigkeit(Enum):
    LEICHT = ("LEICHT", float(0.0125), int(5), float(50), float(40), float(10))
    MITTEL = ("MITTEL", float(0.0375), int(3), float(50), float(25), float(25))
    SCHWER = ("SCHWER", float(0.05), int(1),  float(10), float(25), float(65))
